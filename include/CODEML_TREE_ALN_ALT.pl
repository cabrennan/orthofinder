...
#    my %data = ();
    for (my $i = 0; $i < @t_files; $i++) { 
        system("echo seqfile = /home/santagata/16spp_PAML_HYPHY/$a_files[$i] >> $a_files[$i].ctl");
        system("echo treefile = /home/santagata/16spp_PAML_HYPHY/$t_files[$i] >> $a_files[$i].ctl");
        system("echo outfile = /home/santagata/16spp_PAML_HYPHY/mlcalt_$a_files[$i] >> $a_files[$i].ctl");
        ...
        system("echo fix_omega = 0 >> $a_files[$i].ctl");
